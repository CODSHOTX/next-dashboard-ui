const Pagination = () => {
  return (
    <div className='py-2 flex items-center bg-white justify-between text-gray-500'>
        ...
        <button className="py-2 px-4 rounded-md bg-slate-200 text-xs font-semibold disabled:opacity-50">Next</button>
        </div>
  )
}
